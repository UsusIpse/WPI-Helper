...
class WPIH_OptionsManager {
    ...
    public function settingsPage() {
        ...
        <div class="wrap">
            ...
            <tr><td><?php _e('PHP Version', 'wpih'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'wpih');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'wpih'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'wpih');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'wpih'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'wpih') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'wpih');
            case 'false':
                return __('false', 'wpih');

            case 'Administrator':
                return __('Administrator', 'wpih');
            case 'Editor':
                return __('Editor', 'wpih');
            case 'Author':
                return __('Author', 'wpih');
            case 'Contributor':
                return __('Contributor', 'wpih');
            case 'Subscriber':
                return __('Subscriber', 'wpih');
            case 'Anyone':
                return __('Anyone', 'wpih');
        }
        return $optionValue;
    }
